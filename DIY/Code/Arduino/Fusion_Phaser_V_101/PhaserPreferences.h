...
#ifndef _PHASERPREFERENCES_H_
#define _PHASERPREFERENCES_H_
...
public:
    ...
    typedef struct Preferences_s {
        ...
        PHASERPREFERENCES::ProfileData_t* pProfileData;
